...
## Ручное удаление за 3 шага
### Завершите процессы вируса через Диспетчер задач (Ctrl+Shift+Esc) - найдите и закройте все задачи с названием NewLauncher

## Удалите файлы вируса вручную по путям:
%AppData%\Local\Programs\NewLauncher\
%AppData%\Roaming\Microsoft\Windows\Start Menu\Programs\NewLauncher.lnk

## Очистите реестр через regedit удалив ключи:
